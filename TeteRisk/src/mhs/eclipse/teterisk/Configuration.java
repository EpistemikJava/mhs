...
class Configuration
{
  ...
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
  ...
  /**
   * Returns a configuration parameter value.<br>
   * If the configuration parameter is not set, a default value will be returned instead.
   * 
   * @param key - the configuration parameter key
   ...
   */
  static String getValue( String key, String def )
  {
  ...
  /**
   * Returns the color configured for the specified key.<br>
   * The key will be prepended with "tetris.color." and the value will be read from the system properties.
   * The color value must be specified in hexadecimal web format, i.e. in the "#RRGGBB" format.
   * If the default color isn't in a valid format, white will be returned.
   * 
   * @param key - the configuration parameter key
   ...
   */
  static Color getColor( String key, String def )
  {
  ...
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
   ...
   /**
    * The internal configuration property values. This lookup table is used to avoid
