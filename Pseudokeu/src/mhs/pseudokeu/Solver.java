 ...
 * Port to Java & modifications (c) 2009 by Mark Sattolo <br>
...
class Solver
{
 ...
 // ===========================================================================================================
  ...
  int getVal( final int n ) { return n / nSqrs ; }
  int getRow( final int n ) { return (n / gridLen) % gridLen ; }
  int getCol( final int n ) { return n % gridLen ; }
  
  // find the required index from row and col info
  int getBox( final int r, final int c ) { return( ((r/3) * 3) + (c/3) ); }
  int getSqr( final int r, final int c ) { return( (r * gridLen) + c ); }
   ...
   *  @return index
   */
  int getIndex( final int val, final int row, final int col ) { return (val * nSqrs) + (row * gridLen) + col; }
  ...
  /**
   *  Search the matrix for a solution
  ...
  *************************************************************************************************************/
  ...
  static final String strP4_VERSION = "$Revision: #10 $" ;
